...
func (m *AllRequestBuilder) Organization()(*AllOrganizationRequestBuilder) {
    return NewAllOrganizationRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
