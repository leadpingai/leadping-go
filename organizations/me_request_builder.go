...
// MeRequestBuilder builds and executes requests for operations under \organizations\me
...
func NewMeRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MeRequestBuilder) {
    m := &MeRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/organizations/me", pathParameters),
    }
    return m
}
...
// Get returns the authenticated user's current organization profile, including account settings, billing context, and communication configuration.
...
// Post creates an organization account for the authenticated user, assigns them as its owner, and makes it their active organization context.
// returns a OrganizationResponseable when successful
// returns a ProblemDetails error when the service returns a 400 status code
// returns a ProblemDetails error when the service returns a 401 status code
// returns a ProblemDetails error when the service returns a 429 status code
func (m *MeRequestBuilder) Post(ctx context.Context, body i01c1fcf104a8c6ee60f7ac9622055caa34c4bc3debe751d81944bd1693855811.OrganizationRequestable, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(i01c1fcf104a8c6ee60f7ac9622055caa34c4bc3debe751d81944bd1693855811.OrganizationResponseable, error) {
...
// Put updates the authenticated user's current organization profile, including contact, settings, and communication configuration.
// returns a OrganizationResponseable when successful
// returns a ProblemDetails error when the service returns a 400 status code
// returns a ProblemDetails error when the service returns a 401 status code
// returns a ProblemDetails error when the service returns a 429 status code
...
// ToGetRequestInformation returns the authenticated user's current organization profile, including account settings, billing context, and communication configuration.
...
// ToPostRequestInformation creates an organization account for the authenticated user, assigns them as its owner, and makes it their active organization context.
// returns a *RequestInformation when successful
...
// ToPutRequestInformation updates the authenticated user's current organization profile, including contact, settings, and communication configuration.
// returns a *RequestInformation when successful
