...
func NewInitiateRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InitiateRequestBuilder) {
    m := &InitiateRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/phone-call/initiate", pathParameters),
    }
    return m
}
// NewInitiateRequestBuilder instantiates a new InitiateRequestBuilder and sets the default values.
func NewInitiateRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*InitiateRequestBuilder) {
...
func (m *InitiateRequestBuilder) WithUrl(rawUrl string)(*InitiateRequestBuilder) {
    return NewInitiateRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
