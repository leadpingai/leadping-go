...
// Get lists the payment methods available to the current organization for billing, invoice payments, and wallet funding.
...
// ToGetRequestInformation lists the payment methods available to the current organization for billing, invoice payments, and wallet funding.
