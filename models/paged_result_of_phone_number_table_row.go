...
// PagedResultOfPhoneNumberTableRow a generic container for paginated results returned to the client.
type PagedResultOfPhoneNumberTableRow struct {
...
// NewPagedResultOfPhoneNumberTableRow instantiates a new PagedResultOfPhoneNumberTableRow and sets the default values.
func NewPagedResultOfPhoneNumberTableRow()(*PagedResultOfPhoneNumberTableRow) {
    m := &PagedResultOfPhoneNumberTableRow{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePagedResultOfPhoneNumberTableRowFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePagedResultOfPhoneNumberTableRowFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPagedResultOfPhoneNumberTableRow(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PagedResultOfPhoneNumberTableRow) GetAdditionalData()(map[string]any) {
...
func (m *PagedResultOfPhoneNumberTableRow) GetContinuationToken()(*string) {
    return m.continuationToken
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PagedResultOfPhoneNumberTableRow) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreatePhoneNumberTableRowFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]PhoneNumberTableRowable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(PhoneNumberTableRowable)
                }
            }
            m.SetItems(res)
        }
...
// returns a []PhoneNumberTableRowable when successful
func (m *PagedResultOfPhoneNumberTableRow) GetItems()([]PhoneNumberTableRowable) {
    return m.items
}
...
func (m *PagedResultOfPhoneNumberTableRow) GetPageSize()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.pageSize
}
...
// returns a UntypedNodeable when successful
func (m *PagedResultOfPhoneNumberTableRow) GetTotalCount()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.totalCount
}
// Serialize serializes information the current object
func (m *PagedResultOfPhoneNumberTableRow) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagedResultOfPhoneNumberTableRow) SetAdditionalData(value map[string]any)() {
...
func (m *PagedResultOfPhoneNumberTableRow) SetContinuationToken(value *string)() {
    m.continuationToken = value
}
// SetItems sets the items property value. The subset of items returned for the current page.
func (m *PagedResultOfPhoneNumberTableRow) SetItems(value []PhoneNumberTableRowable)() {
    m.items = value
}
...
func (m *PagedResultOfPhoneNumberTableRow) SetPageSize(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.pageSize = value
}
...
func (m *PagedResultOfPhoneNumberTableRow) SetTotalCount(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.totalCount = value
}
type PagedResultOfPhoneNumberTableRowable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetContinuationToken()(*string)
    GetItems()([]PhoneNumberTableRowable)
    ...
    SetItems(value []PhoneNumberTableRowable)()
