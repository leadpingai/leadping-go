...
// GetStatus gets the status property value. Describes the lifecycle of an organization membership invitation from issuance through acceptance, expiration, or revocation.
...
// SetStatus sets the status property value. Describes the lifecycle of an organization membership invitation from issuance through acceptance, expiration, or revocation.
