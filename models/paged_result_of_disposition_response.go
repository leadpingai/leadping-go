...
// PagedResultOfDispositionResponse a generic container for paginated results returned to the client.
type PagedResultOfDispositionResponse struct {
...
// NewPagedResultOfDispositionResponse instantiates a new PagedResultOfDispositionResponse and sets the default values.
func NewPagedResultOfDispositionResponse()(*PagedResultOfDispositionResponse) {
    m := &PagedResultOfDispositionResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePagedResultOfDispositionResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePagedResultOfDispositionResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPagedResultOfDispositionResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PagedResultOfDispositionResponse) GetAdditionalData()(map[string]any) {
...
func (m *PagedResultOfDispositionResponse) GetContinuationToken()(*string) {
    return m.continuationToken
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PagedResultOfDispositionResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateDispositionResponseFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]DispositionResponseable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(DispositionResponseable)
                }
            }
            m.SetItems(res)
        }
...
func (m *PagedResultOfDispositionResponse) GetItems()([]DispositionResponseable) {
    return m.items
}
...
func (m *PagedResultOfDispositionResponse) GetPageSize()(*int32) {
    return m.pageSize
}
...
// returns a *int32 when successful
func (m *PagedResultOfDispositionResponse) GetTotalCount()(*int32) {
    return m.totalCount
}
// Serialize serializes information the current object
func (m *PagedResultOfDispositionResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagedResultOfDispositionResponse) SetAdditionalData(value map[string]any)() {
...
func (m *PagedResultOfDispositionResponse) SetContinuationToken(value *string)() {
    m.continuationToken = value
}
// SetItems sets the items property value. The subset of items returned for the current page.
func (m *PagedResultOfDispositionResponse) SetItems(value []DispositionResponseable)() {
    m.items = value
}
...
func (m *PagedResultOfDispositionResponse) SetPageSize(value *int32)() {
    m.pageSize = value
}
...
func (m *PagedResultOfDispositionResponse) SetTotalCount(value *int32)() {
    m.totalCount = value
}
type PagedResultOfDispositionResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetContinuationToken()(*string)
    GetItems()([]DispositionResponseable)
    GetPageSize()(*int32)
    GetTotalCount()(*int32)
    SetContinuationToken(value *string)()
    SetItems(value []DispositionResponseable)()
