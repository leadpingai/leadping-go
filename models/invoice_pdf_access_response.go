...
// InvoicePdfAccessResponse short-lived access details for a private Leadping invoice PDF.
...
func NewInvoicePdfAccessResponse()(*InvoicePdfAccessResponse) {
    m := &InvoicePdfAccessResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateInvoicePdfAccessResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateInvoicePdfAccessResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewInvoicePdfAccessResponse(), nil
}
...
func (m *InvoicePdfAccessResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *InvoicePdfAccessResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
type InvoicePdfAccessResponseable interface {
