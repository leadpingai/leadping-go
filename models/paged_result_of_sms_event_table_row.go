...
// PagedResultOfSmsEventTableRow a generic container for paginated results returned to the client.
type PagedResultOfSmsEventTableRow struct {
...
// NewPagedResultOfSmsEventTableRow instantiates a new PagedResultOfSmsEventTableRow and sets the default values.
func NewPagedResultOfSmsEventTableRow()(*PagedResultOfSmsEventTableRow) {
    m := &PagedResultOfSmsEventTableRow{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePagedResultOfSmsEventTableRowFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePagedResultOfSmsEventTableRowFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPagedResultOfSmsEventTableRow(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PagedResultOfSmsEventTableRow) GetAdditionalData()(map[string]any) {
...
func (m *PagedResultOfSmsEventTableRow) GetContinuationToken()(*string) {
    return m.continuationToken
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PagedResultOfSmsEventTableRow) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateSmsEventTableRowFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]SmsEventTableRowable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(SmsEventTableRowable)
                }
            }
            m.SetItems(res)
        }
...
func (m *PagedResultOfSmsEventTableRow) GetItems()([]SmsEventTableRowable) {
    return m.items
}
...
func (m *PagedResultOfSmsEventTableRow) GetPageSize()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.pageSize
}
...
// returns a UntypedNodeable when successful
func (m *PagedResultOfSmsEventTableRow) GetTotalCount()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.totalCount
}
// Serialize serializes information the current object
func (m *PagedResultOfSmsEventTableRow) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagedResultOfSmsEventTableRow) SetAdditionalData(value map[string]any)() {
...
func (m *PagedResultOfSmsEventTableRow) SetContinuationToken(value *string)() {
    m.continuationToken = value
}
// SetItems sets the items property value. The subset of items returned for the current page.
func (m *PagedResultOfSmsEventTableRow) SetItems(value []SmsEventTableRowable)() {
    m.items = value
}
...
func (m *PagedResultOfSmsEventTableRow) SetPageSize(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.pageSize = value
}
...
func (m *PagedResultOfSmsEventTableRow) SetTotalCount(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.totalCount = value
}
type PagedResultOfSmsEventTableRowable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetContinuationToken()(*string)
    GetItems()([]SmsEventTableRowable)
    ...
    SetItems(value []SmsEventTableRowable)()
