...
// PagedResultOfSmsEventTableRow returns one page of query results together with page-size, optional total-count, and opaque continuation-cursor metadata.
...
// returns a *int32 when successful
func (m *PagedResultOfSmsEventTableRow) GetTotalCount()(*int32) {
    return m.totalCount
}
...
func (m *PagedResultOfSmsEventTableRow) SetTotalCount(value *int32)() {
    m.totalCount = value
}
