...
// PagedResultOfTransactionTableRow a generic container for paginated results returned to the client.
type PagedResultOfTransactionTableRow struct {
...
// NewPagedResultOfTransactionTableRow instantiates a new PagedResultOfTransactionTableRow and sets the default values.
func NewPagedResultOfTransactionTableRow()(*PagedResultOfTransactionTableRow) {
    m := &PagedResultOfTransactionTableRow{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePagedResultOfTransactionTableRowFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePagedResultOfTransactionTableRowFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPagedResultOfTransactionTableRow(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PagedResultOfTransactionTableRow) GetAdditionalData()(map[string]any) {
...
func (m *PagedResultOfTransactionTableRow) GetContinuationToken()(*string) {
    return m.continuationToken
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PagedResultOfTransactionTableRow) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateTransactionTableRowFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]TransactionTableRowable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(TransactionTableRowable)
                }
            }
            m.SetItems(res)
        }
...
// returns a []TransactionTableRowable when successful
func (m *PagedResultOfTransactionTableRow) GetItems()([]TransactionTableRowable) {
    return m.items
}
...
func (m *PagedResultOfTransactionTableRow) GetPageSize()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.pageSize
}
...
// returns a UntypedNodeable when successful
func (m *PagedResultOfTransactionTableRow) GetTotalCount()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.totalCount
}
// Serialize serializes information the current object
func (m *PagedResultOfTransactionTableRow) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagedResultOfTransactionTableRow) SetAdditionalData(value map[string]any)() {
...
func (m *PagedResultOfTransactionTableRow) SetContinuationToken(value *string)() {
    m.continuationToken = value
}
// SetItems sets the items property value. The subset of items returned for the current page.
func (m *PagedResultOfTransactionTableRow) SetItems(value []TransactionTableRowable)() {
    m.items = value
}
...
func (m *PagedResultOfTransactionTableRow) SetPageSize(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.pageSize = value
}
...
func (m *PagedResultOfTransactionTableRow) SetTotalCount(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.totalCount = value
}
type PagedResultOfTransactionTableRowable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetContinuationToken()(*string)
    GetItems()([]TransactionTableRowable)
    ...
    SetItems(value []TransactionTableRowable)()
