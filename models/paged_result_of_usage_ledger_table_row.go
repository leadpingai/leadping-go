...
// PagedResultOfUsageLedgerTableRow returns one page of query results together with page-size, optional total-count, and opaque continuation-cursor metadata.
...
// returns a *int32 when successful
func (m *PagedResultOfUsageLedgerTableRow) GetTotalCount()(*int32) {
    return m.totalCount
}
...
func (m *PagedResultOfUsageLedgerTableRow) SetTotalCount(value *int32)() {
    m.totalCount = value
}
