...
// PagedResultOfUsageLedgerTableRow a generic container for paginated results returned to the client.
type PagedResultOfUsageLedgerTableRow struct {
...
// NewPagedResultOfUsageLedgerTableRow instantiates a new PagedResultOfUsageLedgerTableRow and sets the default values.
func NewPagedResultOfUsageLedgerTableRow()(*PagedResultOfUsageLedgerTableRow) {
    m := &PagedResultOfUsageLedgerTableRow{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePagedResultOfUsageLedgerTableRowFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePagedResultOfUsageLedgerTableRowFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPagedResultOfUsageLedgerTableRow(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PagedResultOfUsageLedgerTableRow) GetAdditionalData()(map[string]any) {
...
func (m *PagedResultOfUsageLedgerTableRow) GetContinuationToken()(*string) {
    return m.continuationToken
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PagedResultOfUsageLedgerTableRow) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateUsageLedgerTableRowFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]UsageLedgerTableRowable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(UsageLedgerTableRowable)
                }
            }
            m.SetItems(res)
        }
...
// returns a []UsageLedgerTableRowable when successful
func (m *PagedResultOfUsageLedgerTableRow) GetItems()([]UsageLedgerTableRowable) {
    return m.items
}
...
func (m *PagedResultOfUsageLedgerTableRow) GetPageSize()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.pageSize
}
...
// returns a UntypedNodeable when successful
func (m *PagedResultOfUsageLedgerTableRow) GetTotalCount()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.totalCount
}
// Serialize serializes information the current object
func (m *PagedResultOfUsageLedgerTableRow) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagedResultOfUsageLedgerTableRow) SetAdditionalData(value map[string]any)() {
...
func (m *PagedResultOfUsageLedgerTableRow) SetContinuationToken(value *string)() {
    m.continuationToken = value
}
// SetItems sets the items property value. The subset of items returned for the current page.
func (m *PagedResultOfUsageLedgerTableRow) SetItems(value []UsageLedgerTableRowable)() {
    m.items = value
}
...
func (m *PagedResultOfUsageLedgerTableRow) SetPageSize(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.pageSize = value
}
...
func (m *PagedResultOfUsageLedgerTableRow) SetTotalCount(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.totalCount = value
}
type PagedResultOfUsageLedgerTableRowable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetContinuationToken()(*string)
    GetItems()([]UsageLedgerTableRowable)
    ...
    SetItems(value []UsageLedgerTableRowable)()
