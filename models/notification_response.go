...
// NotificationResponse describes notification data used in Leadping API requests and responses.
...
// NewNotificationResponse instantiates a new NotificationResponse and sets the default values.
...
// CreateNotificationResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateNotificationResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewNotificationResponse(), nil
}
// GetActionButtonText gets the actionButtonText property value. Action button text for this notification.
// returns a *string when successful
func (m *NotificationResponse) GetActionButtonText()(*string) {
    return m.actionButtonText
}
// GetActionUrl gets the actionUrl property value. The URL associated with this notification.
// returns a *string when successful
func (m *NotificationResponse) GetActionUrl()(*string) {
    return m.actionUrl
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *NotificationResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCreatedAt gets the createdAt property value. The date and time when the entity was created.
// returns a *Time when successful
func (m *NotificationResponse) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetDetails gets the details property value. Optional supporting details displayed beneath the notification message.
// returns a *string when successful
func (m *NotificationResponse) GetDetails()(*string) {
    return m.details
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *NotificationResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *Time when successful
func (m *NotificationResponse) GetModifiedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.modifiedAt
}
// GetName gets the name property value. The display name for the entity.
// returns a *string when successful
func (m *NotificationResponse) GetName()(*string) {
    return m.name
}
...
// returns a *Time when successful
func (m *NotificationResponse) GetReadAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.readAt
}
// GetRelatedEntityId gets the relatedEntityId property value. The related entity ID associated with this notification.
// returns a *string when successful
func (m *NotificationResponse) GetRelatedEntityId()(*string) {
...
// returns a *string when successful
func (m *NotificationResponse) GetRelatedEntityType()(*string) {
...
func (m *NotificationResponse) GetTypeEscaped()(*NotificationType) {
    return m.typeEscaped
}
// GetUserId gets the userId property value. The user ID associated with this notification.
// returns a *string when successful
func (m *NotificationResponse) GetUserId()(*string) {
    return m.userId
}
// Serialize serializes information the current object
func (m *NotificationResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *NotificationResponse) SetMessage(value *string)() {
    m.message = value
}
// SetModifiedAt sets the modifiedAt property value. The date and time when the entity was last modified, if applicable.
func (m *NotificationResponse) SetModifiedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.modifiedAt = value
}
// SetName sets the name property value. The display name for the entity.
func (m *NotificationResponse) SetName(value *string)() {
    m.name = value
}
...
func (m *NotificationResponse) SetRelatedEntityId(value *string)() {
...
func (m *NotificationResponse) SetRelatedEntityType(value *string)() {
    m.relatedEntityType = value
}
// SetTypeEscaped sets the type property value. The type classification for this notification.
func (m *NotificationResponse) SetTypeEscaped(value *NotificationType)() {
    m.typeEscaped = value
}
// SetUserId sets the userId property value. The user ID associated with this notification.
func (m *NotificationResponse) SetUserId(value *string)() {
    m.userId = value
}
