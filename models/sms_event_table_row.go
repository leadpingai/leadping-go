...
// SmsEventTableRow aPI DTO containing SMS event data used by Leadping API contracts.
...
// GetActorDisplayName gets the actorDisplayName property value. The actor display name associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetActorDisplayName()(*string) {
    return m.actorDisplayName
}
// GetActorUserId gets the actorUserId property value. The actor user ID associated with this SMS event.
// returns a *string when successful
...
// GetBillableAmount gets the billableAmount property value. The monetary billable amount for this SMS event.
...
// GetBillingStatus gets the billingStatus property value. The current billing status for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetBillingStatus()(*string) {
    return m.billingStatus
}
// GetBlockedAt gets the blockedAt property value. The date and time for the blocked at value on this SMS event.
// returns a *Time when successful
func (m *SmsEventTableRow) GetBlockedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.blockedAt
}
// GetBusiness gets the business property value. The business value for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetBusiness()(*string) {
    return m.business
}
// GetBusinessName gets the businessName property value. The display name for the business associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetBusinessName()(*string) {
    return m.businessName
}
// GetCanceledAt gets the canceledAt property value. The date and time for the canceled at value on this SMS event.
// returns a *Time when successful
func (m *SmsEventTableRow) GetCanceledAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.canceledAt
}
// GetCancelReason gets the cancelReason property value. The human-readable cancel reason explaining this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetCancelReason()(*string) {
    return m.cancelReason
}
// GetComplianceAction gets the complianceAction property value. The compliance action value for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetComplianceAction()(*string) {
    return m.complianceAction
}
// GetConversationId gets the conversationId property value. The conversation ID associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetConversationId()(*string) {
    return m.conversationId
}
// GetCreatedAt gets the createdAt property value. The date and time for the created at value on this SMS event.
// returns a *Time when successful
func (m *SmsEventTableRow) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetDeliveredAt gets the deliveredAt property value. The date and time for the delivered at value on this SMS event.
// returns a *Time when successful
...
// GetDirection gets the direction property value. The direction value for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetDirection()(*string) {
    return m.direction
}
// GetErrorCode gets the errorCode property value. The error code value for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetErrorCode()(*string) {
    return m.errorCode
}
// GetErrorMessage gets the errorMessage property value. The error message value for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetErrorMessage()(*string) {
    return m.errorMessage
}
// GetFailedAt gets the failedAt property value. The date and time for the failed at value on this SMS event.
// returns a *Time when successful
...
// GetFromPhoneNumber gets the fromPhoneNumber property value. The phone number associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetFromPhoneNumber()(*string) {
    return m.fromPhoneNumber
}
// GetFromPhoneNumberId gets the fromPhoneNumberId property value. The from phone number ID associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetFromPhoneNumberId()(*string) {
    return m.fromPhoneNumberId
}
// GetId gets the id property value. The unique ID for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetId()(*string) {
    return m.id
}
// GetIsAutomated gets the isAutomated property value. Whether this SMS event was generated by automation.
// returns a *bool when successful
func (m *SmsEventTableRow) GetIsAutomated()(*bool) {
    return m.isAutomated
}
// GetIsWarmup gets the isWarmup property value. Whether this SMS event is warmup.
// returns a *bool when successful
func (m *SmsEventTableRow) GetIsWarmup()(*bool) {
    return m.isWarmup
}
// GetLeadId gets the leadId property value. The lead ID associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetLeadId()(*string) {
    return m.leadId
}
// GetLeadName gets the leadName property value. The display name for the lead associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetLeadName()(*string) {
    return m.leadName
}
// GetOutboundPhoneNumberId gets the outboundPhoneNumberId property value. The outbound phone number ID associated with this SMS event.
// returns a *string when successful
...
// GetProviderMessageId gets the providerMessageId property value. The provider message ID associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetProviderMessageId()(*string) {
    return m.providerMessageId
}
// GetQueuedAt gets the queuedAt property value. The date and time for the queued at value on this SMS event.
// returns a *Time when successful
func (m *SmsEventTableRow) GetQueuedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.queuedAt
}
// GetReceivedAt gets the receivedAt property value. The date and time for the received at value on this SMS event.
// returns a *Time when successful
func (m *SmsEventTableRow) GetReceivedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.receivedAt
}
// GetScheduledFor gets the scheduledFor property value. The date and time for the scheduled for value on this SMS event.
// returns a *Time when successful
...
// GetScheduledReason gets the scheduledReason property value. The human-readable scheduled reason explaining this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetScheduledReason()(*string) {
    return m.scheduledReason
}
// GetSenderName gets the senderName property value. The resolved display name for the party that sent the message.
// returns a *string when successful
func (m *SmsEventTableRow) GetSenderName()(*string) {
    return m.senderName
}
// GetSendingStartedAt gets the sendingStartedAt property value. The date and time for the sending started at value on this SMS event.
// returns a *Time when successful
...
// GetSentAt gets the sentAt property value. The date and time for the sent at value on this SMS event.
// returns a *Time when successful
...
// GetStatusReason gets the statusReason property value. The human-readable status reason explaining this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetStatusReason()(*string) {
    return m.statusReason
}
// GetTelnyxId gets the telnyxId property value. The Telnyx ID associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetTelnyxId()(*string) {
    return m.telnyxId
}
// GetTenDlcCampaignId gets the tenDlcCampaignId property value. The 10DLC campaign ID associated with this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetTenDlcCampaignId()(*string) {
    return m.tenDlcCampaignId
}
// GetText gets the text property value. The text value for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetText()(*string) {
    return m.text
}
// GetToPhoneNumber gets the toPhoneNumber property value. The phone number associated with this SMS event.
// returns a *string when successful
...
// GetUndeliverableAt gets the undeliverableAt property value. The date and time for the undeliverable at value on this SMS event.
// returns a *Time when successful
...
// GetUser gets the user property value. The user value for this SMS event.
// returns a *string when successful
func (m *SmsEventTableRow) GetUser()(*string) {
    return m.user
}
// GetUserName gets the userName property value. The display name for the user associated with this SMS event.
// returns a *string when successful
...
// SetActorDisplayName sets the actorDisplayName property value. The actor display name associated with this SMS event.
func (m *SmsEventTableRow) SetActorDisplayName(value *string)() {
    m.actorDisplayName = value
}
// SetActorUserId sets the actorUserId property value. The actor user ID associated with this SMS event.
...
// SetBillableAmount sets the billableAmount property value. The monetary billable amount for this SMS event.
...
// SetBillingStatus sets the billingStatus property value. The current billing status for this SMS event.
func (m *SmsEventTableRow) SetBillingStatus(value *string)() {
    m.billingStatus = value
}
// SetBlockedAt sets the blockedAt property value. The date and time for the blocked at value on this SMS event.
func (m *SmsEventTableRow) SetBlockedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.blockedAt = value
}
// SetBusiness sets the business property value. The business value for this SMS event.
func (m *SmsEventTableRow) SetBusiness(value *string)() {
    m.business = value
}
// SetBusinessName sets the businessName property value. The display name for the business associated with this SMS event.
func (m *SmsEventTableRow) SetBusinessName(value *string)() {
    m.businessName = value
}
// SetCanceledAt sets the canceledAt property value. The date and time for the canceled at value on this SMS event.
func (m *SmsEventTableRow) SetCanceledAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.canceledAt = value
}
// SetCancelReason sets the cancelReason property value. The human-readable cancel reason explaining this SMS event.
func (m *SmsEventTableRow) SetCancelReason(value *string)() {
    m.cancelReason = value
}
// SetComplianceAction sets the complianceAction property value. The compliance action value for this SMS event.
func (m *SmsEventTableRow) SetComplianceAction(value *string)() {
    m.complianceAction = value
}
// SetConversationId sets the conversationId property value. The conversation ID associated with this SMS event.
func (m *SmsEventTableRow) SetConversationId(value *string)() {
    m.conversationId = value
}
// SetCreatedAt sets the createdAt property value. The date and time for the created at value on this SMS event.
func (m *SmsEventTableRow) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetDeliveredAt sets the deliveredAt property value. The date and time for the delivered at value on this SMS event.
func (m *SmsEventTableRow) SetDeliveredAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.deliveredAt = value
}
// SetDirection sets the direction property value. The direction value for this SMS event.
func (m *SmsEventTableRow) SetDirection(value *string)() {
    m.direction = value
}
// SetErrorCode sets the errorCode property value. The error code value for this SMS event.
func (m *SmsEventTableRow) SetErrorCode(value *string)() {
    m.errorCode = value
}
// SetErrorMessage sets the errorMessage property value. The error message value for this SMS event.
func (m *SmsEventTableRow) SetErrorMessage(value *string)() {
    m.errorMessage = value
}
// SetFailedAt sets the failedAt property value. The date and time for the failed at value on this SMS event.
func (m *SmsEventTableRow) SetFailedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.failedAt = value
}
// SetFromPhoneNumber sets the fromPhoneNumber property value. The phone number associated with this SMS event.
func (m *SmsEventTableRow) SetFromPhoneNumber(value *string)() {
    m.fromPhoneNumber = value
}
// SetFromPhoneNumberId sets the fromPhoneNumberId property value. The from phone number ID associated with this SMS event.
func (m *SmsEventTableRow) SetFromPhoneNumberId(value *string)() {
    m.fromPhoneNumberId = value
}
// SetId sets the id property value. The unique ID for this SMS event.
func (m *SmsEventTableRow) SetId(value *string)() {
    m.id = value
}
// SetIsAutomated sets the isAutomated property value. Whether this SMS event was generated by automation.
func (m *SmsEventTableRow) SetIsAutomated(value *bool)() {
    m.isAutomated = value
}
// SetIsWarmup sets the isWarmup property value. Whether this SMS event is warmup.
func (m *SmsEventTableRow) SetIsWarmup(value *bool)() {
    m.isWarmup = value
}
// SetLeadId sets the leadId property value. The lead ID associated with this SMS event.
func (m *SmsEventTableRow) SetLeadId(value *string)() {
    m.leadId = value
}
// SetLeadName sets the leadName property value. The display name for the lead associated with this SMS event.
func (m *SmsEventTableRow) SetLeadName(value *string)() {
    m.leadName = value
}
// SetOutboundPhoneNumberId sets the outboundPhoneNumberId property value. The outbound phone number ID associated with this SMS event.
...
// SetProviderMessageId sets the providerMessageId property value. The provider message ID associated with this SMS event.
func (m *SmsEventTableRow) SetProviderMessageId(value *string)() {
    m.providerMessageId = value
}
// SetQueuedAt sets the queuedAt property value. The date and time for the queued at value on this SMS event.
func (m *SmsEventTableRow) SetQueuedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.queuedAt = value
}
// SetReceivedAt sets the receivedAt property value. The date and time for the received at value on this SMS event.
func (m *SmsEventTableRow) SetReceivedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.receivedAt = value
}
// SetScheduledFor sets the scheduledFor property value. The date and time for the scheduled for value on this SMS event.
...
// SetScheduledReason sets the scheduledReason property value. The human-readable scheduled reason explaining this SMS event.
func (m *SmsEventTableRow) SetScheduledReason(value *string)() {
    m.scheduledReason = value
}
// SetSenderName sets the senderName property value. The resolved display name for the party that sent the message.
func (m *SmsEventTableRow) SetSenderName(value *string)() {
    m.senderName = value
}
// SetSendingStartedAt sets the sendingStartedAt property value. The date and time for the sending started at value on this SMS event.
...
// SetSentAt sets the sentAt property value. The date and time for the sent at value on this SMS event.
...
// SetStatusReason sets the statusReason property value. The human-readable status reason explaining this SMS event.
func (m *SmsEventTableRow) SetStatusReason(value *string)() {
    m.statusReason = value
}
// SetTelnyxId sets the telnyxId property value. The Telnyx ID associated with this SMS event.
func (m *SmsEventTableRow) SetTelnyxId(value *string)() {
    m.telnyxId = value
}
// SetTenDlcCampaignId sets the tenDlcCampaignId property value. The 10DLC campaign ID associated with this SMS event.
func (m *SmsEventTableRow) SetTenDlcCampaignId(value *string)() {
    m.tenDlcCampaignId = value
}
// SetText sets the text property value. The text value for this SMS event.
func (m *SmsEventTableRow) SetText(value *string)() {
    m.text = value
}
// SetToPhoneNumber sets the toPhoneNumber property value. The phone number associated with this SMS event.
...
// SetUndeliverableAt sets the undeliverableAt property value. The date and time for the undeliverable at value on this SMS event.
...
// SetUser sets the user property value. The user value for this SMS event.
func (m *SmsEventTableRow) SetUser(value *string)() {
    m.user = value
}
// SetUserName sets the userName property value. The display name for the user associated with this SMS event.
