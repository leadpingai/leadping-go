...
// PagedResultOfLeadStatusChangeResponse a generic container for paginated results returned to the client.
type PagedResultOfLeadStatusChangeResponse struct {
    ...
    items []LeadStatusChangeResponseable
...
// NewPagedResultOfLeadStatusChangeResponse instantiates a new PagedResultOfLeadStatusChangeResponse and sets the default values.
func NewPagedResultOfLeadStatusChangeResponse()(*PagedResultOfLeadStatusChangeResponse) {
    m := &PagedResultOfLeadStatusChangeResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePagedResultOfLeadStatusChangeResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePagedResultOfLeadStatusChangeResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPagedResultOfLeadStatusChangeResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PagedResultOfLeadStatusChangeResponse) GetAdditionalData()(map[string]any) {
...
func (m *PagedResultOfLeadStatusChangeResponse) GetContinuationToken()(*string) {
    return m.continuationToken
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PagedResultOfLeadStatusChangeResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateLeadStatusChangeResponseFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]LeadStatusChangeResponseable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(LeadStatusChangeResponseable)
                }
            }
            m.SetItems(res)
        }
...
func (m *PagedResultOfLeadStatusChangeResponse) GetItems()([]LeadStatusChangeResponseable) {
    return m.items
}
...
func (m *PagedResultOfLeadStatusChangeResponse) GetPageSize()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.pageSize
}
...
// returns a UntypedNodeable when successful
func (m *PagedResultOfLeadStatusChangeResponse) GetTotalCount()(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable) {
    return m.totalCount
}
// Serialize serializes information the current object
func (m *PagedResultOfLeadStatusChangeResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagedResultOfLeadStatusChangeResponse) SetAdditionalData(value map[string]any)() {
...
func (m *PagedResultOfLeadStatusChangeResponse) SetContinuationToken(value *string)() {
    m.continuationToken = value
}
// SetItems sets the items property value. The subset of items returned for the current page.
func (m *PagedResultOfLeadStatusChangeResponse) SetItems(value []LeadStatusChangeResponseable)() {
    m.items = value
}
...
func (m *PagedResultOfLeadStatusChangeResponse) SetPageSize(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.pageSize = value
}
...
func (m *PagedResultOfLeadStatusChangeResponse) SetTotalCount(value i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.UntypedNodeable)() {
    m.totalCount = value
}
type PagedResultOfLeadStatusChangeResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetContinuationToken()(*string)
    GetItems()([]LeadStatusChangeResponseable)
    ...
    SetItems(value []LeadStatusChangeResponseable)()
