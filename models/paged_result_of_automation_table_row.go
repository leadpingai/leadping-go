...
// PagedResultOfAutomationTableRow returns one page of query results together with page-size, optional total-count, and opaque continuation-cursor metadata.
type PagedResultOfAutomationTableRow struct {
...
func NewPagedResultOfAutomationTableRow()(*PagedResultOfAutomationTableRow) {
    m := &PagedResultOfAutomationTableRow{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePagedResultOfAutomationTableRowFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePagedResultOfAutomationTableRowFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPagedResultOfAutomationTableRow(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PagedResultOfAutomationTableRow) GetAdditionalData()(map[string]any) {
...
func (m *PagedResultOfAutomationTableRow) GetContinuationToken()(*string) {
    return m.continuationToken
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *PagedResultOfAutomationTableRow) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["items"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateAutomationTableRowFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]AutomationTableRowable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(AutomationTableRowable)
                }
            }
            m.SetItems(res)
        }
...
// returns a []AutomationTableRowable when successful
func (m *PagedResultOfAutomationTableRow) GetItems()([]AutomationTableRowable) {
    return m.items
}
...
func (m *PagedResultOfAutomationTableRow) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PagedResultOfAutomationTableRow) SetAdditionalData(value map[string]any)() {
...
func (m *PagedResultOfAutomationTableRow) SetContinuationToken(value *string)() {
...
func (m *PagedResultOfAutomationTableRow) SetItems(value []AutomationTableRowable)() {
    m.items = value
}
