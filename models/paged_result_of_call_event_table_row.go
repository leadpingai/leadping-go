...
// PagedResultOfCallEventTableRow returns one page of query results together with page-size, optional total-count, and opaque continuation-cursor metadata.
...
// returns a *int32 when successful
func (m *PagedResultOfCallEventTableRow) GetTotalCount()(*int32) {
    return m.totalCount
}
...
func (m *PagedResultOfCallEventTableRow) SetTotalCount(value *int32)() {
    m.totalCount = value
}
