...
// ToGetRequestInformation view lead creation metrics for an organization intake source, including accepted, rejected, duplicate, validation, and recent activity counts.
