...
// Post archive a lead to remove it from active pipeline views while preserving communication and event history. An optional request body supplies the archive reason.
...
// ToPostRequestInformation archive a lead to remove it from active pipeline views while preserving communication and event history. An optional request body supplies the archive reason.
