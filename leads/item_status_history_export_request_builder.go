...
func NewItemStatusHistoryExportRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemStatusHistoryExportRequestBuilder) {
    m := &ItemStatusHistoryExportRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/leads/{%2Did}/status-history/export", pathParameters),
    }
    return m
}
...
func NewItemStatusHistoryExportRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemStatusHistoryExportRequestBuilder) {
    ...
    return NewItemStatusHistoryExportRequestBuilderInternal(urlParams, requestAdapter)
}
// Get exports lead status change data for one lead, packaging outcome history for reporting, audit review, or handoff workflows.
// returns a LeadStatusChangeExportResponseable when successful
...
func (m *ItemStatusHistoryExportRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(i01c1fcf104a8c6ee60f7ac9622055caa34c4bc3debe751d81944bd1693855811.LeadStatusChangeExportResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i01c1fcf104a8c6ee60f7ac9622055caa34c4bc3debe751d81944bd1693855811.CreateLeadStatusChangeExportResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i01c1fcf104a8c6ee60f7ac9622055caa34c4bc3debe751d81944bd1693855811.LeadStatusChangeExportResponseable), nil
}
// ToGetRequestInformation exports lead status change data for one lead, packaging outcome history for reporting, audit review, or handoff workflows.
...
func (m *ItemStatusHistoryExportRequestBuilder) WithUrl(rawUrl string)(*ItemStatusHistoryExportRequestBuilder) {
    return NewItemStatusHistoryExportRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
