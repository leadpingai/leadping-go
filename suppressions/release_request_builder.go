...
func NewReleaseRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ReleaseRequestBuilder) {
    m := &ReleaseRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/suppressions/release", pathParameters),
    }
    return m
}
...
// Post returns the suppression entry response.
...
// ToPostRequestInformation returns the suppression entry response.
...
func (m *ReleaseRequestBuilder) WithUrl(rawUrl string)(*ReleaseRequestBuilder) {
    return NewReleaseRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
